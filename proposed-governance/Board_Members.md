...
>
> **Rationale:** The Board Members page serves as both current reference and historical record. Adding role descriptions and cross-references makes it more useful for members trying to understand the governance structure.
...
*See also: [Bylaws](Bylaws.md) | [Board Elections](Board_Elections.html) | [How to Run HeatSync Labs](How_to_Run_HeatSync_Labs.md)*
