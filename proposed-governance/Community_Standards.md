...
See also: [Rules](Rules.md) for detailed safety and equipment requirements.
...
- **Anonymous:** Physical drop box at the space or anonymous form online
- **Direct to specific board member:** If you're not comfortable with the full board seeing the report
...
3. **Interim measures:** If someone's safety is at risk, the Board may restrict access during the investigation.
4. **Decision:** The Board determines what happened and what response is appropriate.
...
**No waiting for multiple complaints:** The Board is not required to wait for a specific number of reports before taking action. A single credible report of serious behavior is sufficient to investigate and act.
...
For serious violations or continued problems after warnings. Duration: 30-180 days.

- No access to space during suspension
- Card access revoked for suspension period
...
If you hinder the Board's ability to conduct investigation or enforcement procedures, that is itself a violation of these Community Standards and subject to consequences.
...
Appeals are not reviewed by the Board. A **Grievance Committee** shall be formed consisting of:

- One (1) Board member (not involved in the original decision)
- Three (3) members randomly drawn from those present at the next HYH meeting

If any drawn member has a conflict of interest -- as determined by the quorum at HYH -- they shall be excused and replaced with another random member. The request for committee volunteers at HYH shall be generic, with no names or description of the situation disclosed.

The four-person committee shall review the evidence provided to the Board and the consequence assigned. The committee may **uphold**, **revoke**, or **modify** the consequence.

### 8.3 Further Appeal

If you believe the Grievance Committee's decision was still unfair, you may propose a review of your case by the general membership at HYH. The proposal shall be general with no specific information including name or type of situation. All records will be presented to the membership at HYH for review and a vote (records may be redacted to protect victims).

### 8.4 Timeline

- Submit written appeal to conduct@heatsynclabs.org within fourteen (14) days of the decision.
- The Grievance Committee shall convene within thirty (30) days of the appeal submission.

## 9. Weapons Policy

Weapons are allowed at HeatSync Labs events, community spaces, and in other spaces covered by the scope of these Community Standards. Community members are expected to comply with all state and local laws on this matter. Weapons shall be handled carefully, only by those trained to handle them, to minimize risk to guests, members, and themselves.
...
- Consequences may be shared with the community without naming individuals when the Board determines it is necessary for community safety.
- Deliberately making consequences public when the Board has chosen them to be private is itself a violation of these Community Standards.
- If the community needs to know for safety reasons, the Board will communicate appropriately.

## 11. Scope

These Community Standards apply in all community venues -- online and in-person -- as well as in all one-on-one communications pertaining to community business. They also apply to behavior occurring outside the scope of community activities when such behavior has the potential to adversely affect the safety and well-being of community members.

## 12. Amendments

This document may be amended by majority vote at a Hack Your Hackerspace (HYH) meeting, following the standard proposal process defined in the [Community Policies](Community_Policies.md). Per the [Bylaws](Bylaws.md), Article VIII, Community Standards amendments do not require Board ratification.
...
- **Physical drop box:** Location posted at the space
...
*This document is adapted from the [Geek Feminism Community Anti-Harassment Policy](https://geekfeminism.wikia.org/wiki/Community_anti-harassment) and distributed under a [Creative Commons Attribution-ShareAlike 3.0](https://creativecommons.org/licenses/by-sa/3.0/) license.*

---

*See also: [Bylaws](Bylaws.md) | [Community Policies](Community_Policies.md) | [Rules](Rules.md)*
