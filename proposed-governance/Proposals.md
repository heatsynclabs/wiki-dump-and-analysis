...
>
> **Rationale:** The current Proposals page is outdated (last updated 2020) and doesn't reference the detailed Proposal Process now in the Bylaws. This update bridges that gap and provides a practical template for members.

# Proposals

## When is a Proposal Required?

Per the [Bylaws](Bylaws.md), formal proposals are required for:
...
*See also: [Bylaws](Bylaws.md) | [How to Run HeatSync Labs](How_to_Run_HeatSync_Labs.md)*
