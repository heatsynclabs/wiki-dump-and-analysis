...
rationale: >
  The Rules document is comprehensive (116 revisions of organic growth) but lacks a clear enforcement mechanism and damage reporting procedure. The enforcement ladder provides consistent, fair consequences while the damage reporting encourages transparency rather than hiding accidents.
---
...
The Board may skip steps for severe safety violations or [Community Standards](Community_Standards.html) breaches.
...
*See also: [Bylaws](Bylaws.html) | [Community Standards](Community_Standards.html) | [Community Policies](Community_Policies.html) | [Operational Policies](Operational_Policies.html) | [Procedures](Procedures.html)*
